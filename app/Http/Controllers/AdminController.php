...
class AdminController extends Controller
{
    ...
    public function userStore(Request $request){
        ...
        $user->save();
        return redirect()->back()->with('alert', ['type' => 'success', 'msg' => 'Usuario creado con éxito']);
    ...
    public function userUpdate(Request $request){
        ...
        $user->subscription_expired = $request->subscription_expired ?? null;
        $user->save();
        return redirect()->back()->with('alert', ['type' => 'success', 'msg' => 'Usuario actualizado con éxito']);
    }

    public function userDelete($id){
        $user = User::find($id);
        if($user->level == 'admin'){
            return redirect()->back()->with('alert', ['type' => 'danger', 'msg' => 'No puedes eliminar al administrador']);
        }
        ...
        $user->delete();
        return redirect()->back()->with('alert', ['type' => 'success', 'msg' => 'Usuario eliminado exitosamente']);
    }
}
