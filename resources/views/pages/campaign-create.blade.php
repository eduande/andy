...
<script src="{{asset('plugins/datatables/datatables.min.js')}}"></script>
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <div class="row">
                           ...
                           {{-- make form sender,tag  --}}
                            <form  id="form" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Mi Campaña">
                                </div>
                                    </div>
                                    <div class="col-md-6">
                                         <div class="form-group">
                                    <label for="tag">Remitente</label>
                    ...
                    <label for="inputEmail4" class="form-label">Grupo (Contactos)</label>
    ...
    <div class="col ">
        ...
        <select name="tipe" id="tipe" class="form-control" style="width: 100%; height:200px;">
           ...
           <option value="schedule">Calendario</option>
  ...
  <label for="type" class="form-label">Tipo de mensaje</label>
                    <select name="type" id="type" class="js-states form-control" tabindex="-1" required>
                      <option value=""   selected >Seleccione uno</option>
                        ...
                        <option value="image">Imagen Mensaje</option>
                        <option value="button">Botón Mensaje</option>
                               ...
                               {{-- button start --}}
                                <div class="row">
                                    <div class="col-md-12 mt-5">
                                        <button id="startBlast" type="submit" class="btn btn-success">Comenzar</button>
                                    </div>
                                </div>
