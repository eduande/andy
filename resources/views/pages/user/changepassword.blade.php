<x-layout-dashboard title="Rest Api">
    ...
    @endif
                <h2 class="my-5">Cambia la contraseña</h2>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                             <div class="col-md-6"> 
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <button type="submit" name="api_key" class="btn btn-primary">Generar nuevo</button>
                                                </div>
                                                </form>  
                                            </div>
                                            <div class="col-md-6">
                                                <form action="{{route('changeChunk')}}" method="POST">
                                                    @csrf
                                                <div class="input-group mb-3">
                                                    <span class="input-group-text" id="basic-addon1">Mensaje máxima</span>
                                                    ...
                                                    <button type="submit" name="changechunk" class="btn btn-primary">Guardar</button>
                                                </div>
                                                </form>
                                             </div>
                                        </div>
                                        ...
                                        <div class="row m-t-xxl">
                                            <div class="col-md-6">
                                                ...
                                                <div id="settingsCurrentPassword" class="form-text">Nunca comparta su contraseña con nadie.</div>
                                            </div>
                                        </div>
                                        <div class="row m-t-xxl">
                                            <div class="col-md-6">
                                        ...
                                        <div class="row m-t-lg">
                                            <div class="col">
                                                ...
                                                <button type="submit" class="btn btn-primary m-t-sm">Cambia la contraseña</button>
                                            </div>
                                        </div>
                                    </form>
                                    </div>
