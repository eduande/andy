                  ...
                  <thead>
                      <tr>
                          <th>Nombre Usuario</th>
                            <th>Correo</th>
                          <th>Dispositivo total</th>
                          <th>Dispositivo de límite</th>
                          <th>Suscripción</th>
                          <th>Suscripción caducada</th>
                            <th>Acción</th>
                    ...
                    <tbody>
                         ...
                         <tr>
                            ...
                            <td class="d-flex justify-content-center">
                                ...
                                <form action="{{route('user.delete',$user->id)}}"  method="POST" onsubmit="return confirm('¿Estás seguro de que eliminarás a este usuario? todos los datos del usuario también serán eliminados')">
                                    @csrf
                                    @method('DELETE')
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" method="POST" enctype="multipart/form-data" id="formUser">
                    ...
                    <label for="limit_device" class="form-label">Dispositivo de límite</label>
                    <input type="number" name="limit_device" id="limit_device" class="form-control" value="">
                    <label for="active_subscription" class="form-label">Suscripción activa</label><br>
                    <select name="active_subscription" id="active_subscription" class="form-control">
                        <option value="active" selected>Activo</option>
                        <option value="inactive">Inactivo</option>
                        <option value="lifetime">Toda la vida</option>
                    </select><br>
                    <label for="subscription_expired" class="form-label">Subscripcion vencida</label>
                    <input type="date" name="subscription_expired" id="subscription_expired" class="form-control" value="">
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                <button type="submit" id="modalButton" name="submit" class="btn btn-primary">Agregar</button>
                </form>
            </div>
        </div>
    </div>
        ...
        // return;
            ...
            $.ajax({
                ...
                success: function(data) {
                    $('#labelpassword').html('Contraseña *(dejar en blanco si no cambia)');
