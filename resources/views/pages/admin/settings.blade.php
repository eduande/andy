                        ...
                        <div class="page-description page-description-tabbed">
                            ...
                            <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="account-tab" data-bs-toggle="tab" data-bs-target="#server" type="button" role="tab" aria-controls="hoaccountme" aria-selected="true">Servidor</button>
                                </li>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row m-t-lg">
                                           ...
                                           @csrf
                                            <div class="col-md-6">
                                                <label for="typeServer" class="form-label">Configuración del servidor</label>
                                            ...
                                            <div class="col-md-6">
                                                <label for="Port" class="form-label">Puerto Node JS</label>
