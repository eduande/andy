<x-layout-dashboard title="Scan {{$number->body}}">
    <div class="app-content">
        <div class="content-wrapper">
            <div class="container">
                <h4 class="my-5">Cuenta Whatsapp {{$number->body}}</h4>
    
                <div class="alert alert-secondary">No dejes tu teléfono antes de conectarlo.</div>
                <div class="row">
                    <div class="col-xl-12">
                                ...
                                <div class="col-xl-4">
                                    <div class="widget-stats-large-info-container">
                                        <div class="card-header">
                                            <h5 class="card-title">Información de Whatsapp<span class="badge badge-info badge-style-light">Updated 5 min ago</span></h5>
                                        </div>
                                        <div class="card-body account">
    
                                            <ul class="list-group account list-group-flush">
                                                <li class="list-group-item name">Nombre : </li>
                                                <li class="list-group-item number">Número : </li>
                                                <li class="list-group-item device">Dispositivo : </li>
